...
export const metadata: Metadata = {
  title: "Treatments",
  description:
    "Explore private aesthetic and dental services in London and start an informed enquiry with DELVARA.",
};
          ...
          <ul className="mx-auto mt-12 grid max-w-4xl gap-5 lg:grid-cols-2">
            <li>
              <Link
                ...
                className="group relative flex min-h-[16rem] flex-col overflow-hidden rounded-2xl border border-aesthetics/40 bg-gradient-to-br from-aesthetics-soft via-delvara-white to-delvara-bg p-8 transition-all duration-200 hover:-translate-y-0.5 hover:border-aesthetics/60 hover:shadow-[0_18px_40px_rgb(23_45_46/0.08)]"
              >
                <span
                  aria-hidden="true"
